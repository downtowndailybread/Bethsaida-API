...
import org.downtowndailybread.exception.client.{ClientInsertionErrorException, ClientNotFoundException, MissingRequiredClientAttributeException}
import org.downtowndailybread.exception.clientattributetype.ClientAttributeTypeNotFoundException
import org.downtowndailybread.model.{Client, ClientAttribute}

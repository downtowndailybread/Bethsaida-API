...
import org.downtowndailybread.bethsaida.providers.{AuthenticationProvider, DatabaseConnectionProvider}

trait ClientRoutes
extends All with Delete with Find with New with Update {
  this: AuthenticationProvider with JsonSupport with DatabaseConnectionProvider =>
